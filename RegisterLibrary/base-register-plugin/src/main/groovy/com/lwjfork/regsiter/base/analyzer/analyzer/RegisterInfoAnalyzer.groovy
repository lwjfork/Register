package com.lwjfork.regsiter.base.analyzer.analyzer
...
class RegisterInfoAnalyzer implements IAnalyzer {
    ...
    private void outputRegisterInfo() {
        ...
        PluginUtils.printJsonFile(registerInfo, outPath, "${variantInfoModel.variantName}_${Constant.REGISTER_INFO}")
